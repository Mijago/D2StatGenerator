...
class WeaponReport(Report):
    ...
    def save(self):
        with open("%s/%s.html" % (Director.GetResultDirectory(self.membershipType, self.membershipId), "table_all_weapons_used"), "w") as f:
        ...
        with open("%s/%s.csv" % (Director.GetResultDirectory(self.membershipType, self.membershipId), "table_all_weapons_used"), "w") as f:
            self.df.to_csv(f, index=False, line_terminator='\n')

        super().save()

    def getName(self) -> str:
        return "chart_all_weapons_used"
